...
$servername = "main.leskientz.ovh";
$bddname = "projet_web";
$username = "api";
$password = "Ludovic03";

try {
    $dbh = new PDO("mysql:host=$servername;dbname=$bddname", $username, $password);
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE utilisateur SET prenom=:prenom, nom_utilisateur=:nom_utilisateur, password=:password, mail=:mail WHERE ID_utilisateur=:id_utilisateur";
